...
struct DataView: View {
    ...
    var body: some View {
        Form {
            ...
            Section(footer: Text("Sample data for the past month has been automatically added for convenience. You may override it by saving new data.")) {
                Button(action: {
                       ...
                       let sugarLevel = Double(sugarLevelInputStr)
                    {
                        ...
                        let _ = dataViewModel.newHealthInput(date: dateInput, systolicBp: systolicBp, diastolicBp: diastolicBp, weight: weight, sugarLevel: sugarLevel, symptoms: symptomsInputStr)
