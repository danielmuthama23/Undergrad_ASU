...
# [INFO] The flag is sent in the udp layer communication between source IP 54.112.103.47 and destination IP 103.71.7.246 and source port 64087 and destination port 22004
...
tcpdump -q -X -r /tmp/find_flag.pcap > z_level12.txt
