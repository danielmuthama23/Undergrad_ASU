...
# [INFO] The flag is sent in the udp layer communication between source IP 195.228.54.129 and destination IP 146.203.147.75 and source port 22580 and destination port 52429
...
tcpdump -q -X -r /tmp/find_flag.pcap > network_level16_output.txt