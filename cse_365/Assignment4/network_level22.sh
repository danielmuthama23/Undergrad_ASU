...
# [INFO] The flag is sent in the tcp layer communication between source IP 84.187.146.2 and destination IP 45.130.58.183 and source port 49557 and destination port 49949
...
tcpdump -q -X -r /tmp/find_flag.pcap > network_level22_output.txt