...
// two changes made below to fix the defects found with the JUnit test cases

public class Assignment2_corrected {
	...
	public static String Validate()
	{
		...
		// since the card number is 8 digits, we need long integer
				 ...
				 for(i= CARD_LENGHT - 1;  i >=1 ; i= i -2) // CHANGE 1: change to >= 1 instead of >= 2
				 {
				 ...
				 for(i= CARD_LENGHT - 2;  i >= 0; i= i-2)
				 {
					 ...
					 // CHANGE 2: don't just add num, add the sum of the two digits in num
					 if (num < 10) {
						 sum2 = sum2 + num;
					 } else {
						 sum2 = sum2 + 1 + (num % 10);
