"""
Tyler Fichiera - Module 13 In-class Exercise
CSE 475 - Fall '23
"""
...
for values in range(1):
    ...
    torch.nn.utils.clip_grad_norm_(model.parameters(), 5, norm_type=2.0) # TO DO !!!!! think about what is missing and what might be wrong here
    optimizer.step()
