...
# rf_clf = RandomForestClassifier(criterion='gini', min_samples_leaf=1, min_samples_split=10, max_features='auto', random_state=1, n_jobs=-1)
rf_clf = RandomForestClassifier(criterion='gini', min_samples_leaf=1, min_samples_split=10, random_state=1)
