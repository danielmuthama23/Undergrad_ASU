...
plain_model_equal_opportunity_difference = classified_metric_plain_test.accuracy()
...
debias_model_classification_accuracy = classified_metric_debiasing_test.accuracy()
